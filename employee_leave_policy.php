    ...
    var xmlhttp;
        ...
        xmlhttp.onreadystatechange=function()
        {
            if(keystr.length ==0)
                ...
                document.getElementById('empfound').setAttribute('style','position:absolute;top:43%;left:62.5%;width:225px;z-index:10;padding:5px;border: 1px inset black; overflow:auto; height:105px; background-color:#F5F5FF;');
                    }
