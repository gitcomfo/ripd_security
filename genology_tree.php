    ...
    <div class="main_text_box">
        ...
        <div>
                <table  class="formstyle" style="font-family: SolaimanLipi !important;">          
                    ...
                    <tr><td><a onclick='show_stepWise_account()' style='cursor:pointer;'><b>প্রতি স্টেপে টোটাল একাউন্টধারীর সংখ্যা</b></a></td></tr>
                    <tr>
                        <td>
                            <table border="1" align="center" width= 99%" cellpadding="5px" cellspacing="0px">
                                ...
                                <tbody>
                                    <?php
                                    $db_slNo = 0;
                                    $sql_genologyTable = "SELECT cu.account_name, cu.account_number, ct.opening_pin_no, cu.account_open_date, at.account_name as act, ct.referer_id as rfid
                                    ...
                                    $rows = mysql_query($sql_genologyTable);
                                    
                                    while ($row_user_info = mysql_fetch_array($rows)) {
                                        $db_slNo = $db_slNo + 1;
                                        ...
                                        foreach($arr_reffer_name as $arn) $db_referer_name = $arn['account_name'];
