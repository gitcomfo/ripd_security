...
<div class="page_header_div">
    <div class="page_header_title">ট্রেইনিং সিডিউল</div>
</div>
<fieldset id="award_fieldset_style">
    <div style="float: left;">
            <?php
            include_once('includes/areaSearch.php');
            getArea("infoTrainingFromThana()");
            ?>
    </div>
    <div style="float: right; margin-right: 10px;">        
        <input type="hidden" id="method" value="infoTrainingFromThana()">
    ...
    <div style="float: left; padding-bottom: 10px;padding-top: 10px; margin-left: 0px;">
        ...
        <b>শেষের তারিখঃ</b> <input type="text" name="date_to" id="date_to" placeholder="Date To"  onclick="infoTrainingFromThana()">
        <input type="hidden" id="method" value="infoTrainingFromThana()">
        <input type="submit" onclick="infoTrainingFromThana()" value="সাবমিট">
    </div>
    ...
    <span id="office">
        <div class="presen_pro_training_travel_table">
            <table id="office_info_filter" border="1" align="center" width= 99%" cellpadding="5px" cellspacing="0px">
                ...
                <tbody>
                    <?php
                    $sql_programTable = "SELECT * from program, office where program_type = 'training' AND Office_idOffice =idOffice AND program_date between curdate() and '2099-12-31' ORDER BY program_date ASC";
                    $db_slNo = 0;
