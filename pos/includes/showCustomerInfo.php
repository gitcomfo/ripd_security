...
elseif($_GET['selltype']=='2')
{
    ...
    case 2:
            echo "<table width='100%' cellspacing='0' cellpadding='0' style='border: #000000 inset 1px; font-size:20px;'><tr>";
            echo "<td width='50%'>সেলস স্টোর অ্যাকাউন্ট নং: <input id='accountNo' name='accountNo' onblur='showStoreName(this.value)' /></td>";
            echo "<td>সেলস স্টোরের নামঃ <input type='text' id='storeName' name='storeName' readonly /></td>";
            echo "</tr></table>";
        break;
    case 3:
            echo "<table width='100%' cellspacing='0' cellpadding='0' style='border: #000000 inset 1px; font-size:20px;'><tr>";
            echo "<td width='50%'>অফিস অ্যাকাউন্ট নং: <input id='empAccNo' name='empAccNo' onblur='showOffName(this.value)'/></td>";
