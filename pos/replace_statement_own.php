...
$sql_select_replace = $conn->prepare("SELECT * 
                                                FROM replace_product_summary, cfs_user
                                                WHERE cfs_userid = idUser
                                                AND reprosum_store_type = ?
                                                AND reprosum_storeid = ?
                                                ORDER BY reprosum_replace_date");
?>
